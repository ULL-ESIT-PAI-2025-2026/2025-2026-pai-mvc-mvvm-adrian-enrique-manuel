 ...
 * @since Mar 31 2026
 * @description Interface that defines the contract for drawing figures - View.
 */

/**
 * @description Interface that defines the contract for a figure drawer.
...
export interface Drawer {
  ...
  /**
   * @description Draws a figure on the canvas.
