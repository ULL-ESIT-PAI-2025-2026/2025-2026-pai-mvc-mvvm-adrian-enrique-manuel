 ...
 * @since Mar 31 2026
 * @description Strategy class for drawing squares - View.
 */

import { Drawer } from './drawer.js';

/**
 * @description Strategy class for drawing square figures.
...
export class SquareDrawer implements Drawer {
  ...
  /**
   * @description Constructor for SquareDrawer.
   * @param side - The side length of the square.
   */
  constructor(private readonly side: number) {}

  /**
   * @description Draws a square on the canvas with the specified position and color.
